 ...
 */
@ConfigurationProperties(prefix = "notification.service.restcallback.queue")
public class RestCallbackConsumerPropertiesConfiguration implements ConsumerConfiguration {
